...
buttonDisplays['NonPotable'] = '<a class="button display" data-filter=".NonPotable">Non-potable Sources</a>';
//Demand Filters
...
function addSupplyCharts(targetID) {
    ...
    html += buildOutputControl("WasteWater", "_Waste1", "MFOP", "EFLPP,EFLCRT,RECTOT", "Effluent and Reclaimed Water", "3");
