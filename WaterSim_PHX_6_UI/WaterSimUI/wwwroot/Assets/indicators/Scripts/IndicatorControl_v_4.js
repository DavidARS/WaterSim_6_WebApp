...
//    this.canvas = canvas;
    ...
    // SAMPSON UPDATE WIDTH HERE for two line indicator title START 10.19.16
    if (this.canvas.id == "idAWSDividAWSIndicatorCanvas") {
        this.canvas.style.margin = '22px 0 0';
    }
    // SAMPSON UPDATE WIDTH HERE for two line indicator title END 10.19.16
...
function Agforeground(CT, MyLeft, MyTop, MyWidth, MyHeight, Horizon, Val) {
    //
    var divisor = 2.5;
    var Oldvalue = 0;
    var AdjHorizon = 2;
    ...
    groundHeight = (MyHeight + MyTop) - Horizon+2;
    ...
    if (value > 0) {
       ...
       // ValueHeight = (100 - value + 0.5) * Yinc;
        //ValueHeight = ( value) * Yinc;
